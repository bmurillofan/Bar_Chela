        ...
        //Verificar Checkbox angular
            if (empty($_POST['angular'])){
               ...
               if (losCamposEstanVacios_Pregunta()) {
                    ...
                    //Existencia mkdir
                    if (existeArchivo_Pregunta('../../../site_media/html/templates/'.$nombreHTML.'/')) {
                        echo "El directorio del html/template ya existe, por favor eliminelo si desea crearlo nuevamente.";
                    }else{
                        generarArchivoHTML($nombreHTML,$file_name,$tituloHTML,$faviconHTML);
                        echo "Se ha generado correctamente la plantilla html <->";

                        if (existeArchivo_Pregunta('../../../site_media/css/'.$nombreHTML.'/')) {
                               echo "El directorio site_media/CSS ya existe, por favor elimine el template y el css si desea crearlo nuevamente.";
                        }else{
                            generarArchivoCSS_HTML($nombreHTML,$file_name,$tituloHTML,$faviconHTML);
